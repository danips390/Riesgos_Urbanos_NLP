...
# Función para agregar capa al proyecto solo si no existe
def add_layer_if_not_exists(layer, layer_name):
    project = QgsProject.instance()
    existing_layer = project.mapLayersByName(layer_name)
    if not existing_layer:
        project.addMapLayer(layer)
        print(f"Capa '{layer_name}' agregada al proyecto.")
    else:
        print(f"Capa '{layer_name}' ya existe en el proyecto.")
#shapefiles
shapefile_municipios = r"D:\home\[00]_Projects\[01]_School\Tweeter\BackDemo\ArcGis\puntaje_municipios.shp"
shapefile_colonias = r"D:\home\[00]_Projects\[01]_School\Tweeter\BackDemo\ArcGis\puntaje_colonias.shp"
shapefile_calles = r"D:\home\[00]_Projects\[01]_School\Tweeter\BackDemo\ArcGis\puntaje_calles.shp"
...
iconos_svg = {
    "eléctrico": r"D:\home\[00]_Projects\[01]_School\Tweeter\ArcGis\electric.svg",
    "inundación": r"D:\home\[00]_Projects\[01]_School\Tweeter\ArcGis\flood.svg",
    "lluvia": r"D:\home\[00]_Projects\[01]_School\Tweeter\ArcGis\rain.svg",
    "incendio": r"D:\home\[00]_Projects\[01]_School\Tweeter\ArcGis\fire.svg",
    "problema vial": r"D:\home\[00]_Projects\[01]_School\Tweeter\ArcGis\traffic.svg",
    "otros": r"D:\home\[00]_Projects\[01]_School\Tweeter\ArcGis\other.svg"
}
...
if not municipios_layer.isValid() or not colonias_layer.isValid() or not calles_layer.isValid():
    ...
    # Añadir las capas al proyecto solo si no existen
    add_layer_if_not_exists(municipios_layer, "Municipios")
    add_layer_if_not_exists(colonias_layer, "Colonias")
    add_layer_if_not_exists(calles_layer, "Calles")
