...
visualizacion_html  = """
<b>Colonia: </b>[%"colonia_x"%]<br>
<b>Puntaje: </b>[%"Puntaje"%]<br>
<b>Inundación: </b>[%"inundació"%]<br>
<b>Lluvia: </b>[%"lluvia"%]<br>
<b>Incendio: </b>[%"incendio"%]<br>
<b>Problema vial: </b>[%"problema v"%]<br>
<b>Eléctrico: </b>[%"eléctrico"%]<br>
"""
...
if not municipios_layer.isValid() or not colonias_layer.isValid() or not calles_layer.isValid():
   ...
   # Obtener el índice de la columna
    ...
    colonias_layer.setMapTipTemplate(visualizacion_html)
